...
image_num = 3000
# 文件路径
DIR = "E:/WorkSapce/pythonworkspace/ArtificiaLintelligence/cn/huanglins/test/"
...
with tf.name_scope("accuracy"):
    ...
    with tf.name_scope("accuracy"):
        # 求准确率
        # 把correct_prediction变成float32类型
...
if tf.gfile.Exists(DIR + "projector/projector/metadata.tsv"):
    ...
    tf.gfile.MakeDirs(DIR + "projector/projector/")
